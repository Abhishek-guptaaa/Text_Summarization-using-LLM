...
model = ChatGroq(api_key=api_key, model_name="gemma-7b-it", temperature=0.0, verbose=True)
...
summarisation_text = st.text_area("Enter the text you want to summarize", height=200)
